...
<head>
  ...
  <script src="https://cdn.tiny.cloud/1/1e7xg2cntsjs35fn9k15rwx2nm73lsak79vw3m25u2259tix/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="addProject.php" method="POST" enctype="multipart/form-data">
                    ...
                    <script>
                      ...
                      //   menubar: false,
                      //   toolbar: 'undo redo | styleselect | fontsizeselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist',
                    ...
                    <div class="form-group" id="txtEditor">
                      <label for="exampleTextarea1">Objective of the Project</label>
                      <textarea id="editor1" class="form-control" name="pObj" required placeholder="Objective of the Project"></textarea>
                    </div>
                    <script>
                      // tinymce.init({
