    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">  
          <a class="navbar-brand brand-logo" href="dashboard.php"><img src="../images/logo.png" alt="logo" style="width: 100%;"></a>
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item nav-profile dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
              ...
              <a class="dropdown-item"  href="../auth/logout/logout.php">
                ...
                <div class="card-body">
                    ...
                    <div class="card shadow-lg p-3 mb-5 bg-white rounded">
                        <div class="card-body">
                            <?php
                                $gid = $_SESSION["g_id"];
                                $sql = "select * from guides where g_id = $gid";
                        ...
                        <form class="pt-3" action="account.php" method="POST">
                            ...
                            <input type="text" class="form-control form-control-lg" id="name" value="<?php echo $row['g_name'];?>" name="gname" placeholder="Name" disabled>
                            </div>
                            <div class="form-group">
                            <label for="exampleTextarea1">e-mail</label>
                            <input type="text" class="form-control form-control-lg" id="email" name="gemail" value="<?php echo $row['g_email'];?>" placeholder="e-mail" disabled>
                            </div>
                            <div class="mt-3">
                        ...
                        <?php 
                            if(isset($_POST['save'])){
                                ...
                                $name = $_POST['gname'];
                                $email = $_POST['gemail'];
                                $sql = "update guides set g_name='$name',g_email='$email' where g_id = $gid";
                                if (!($result = mysqli_query($link, $sql))) { 
                                  printf("Errormessage: %s\n", mysqli_error($link));
                                }
                              else {  
